...
\begin{enumerate}
	...
	\begin{equation}
		\begin{split}
			T_p & = T_0 + n \cdot (T_1 + T_2) \\
				...
				& = n \cdot \left( \frac{2}{p} + log(\frac{n}{p}) + 2g \right) + \left( 1 + 2n \right) l
		\end{split}
	\end{equation}
	...
	\begin{equation}
		E = \frac{n^2}{p \cdot T_p} = \frac{n^2}{p \cdot \left( n \cdot \left( \frac{2}{p} + log(\frac{n}{p}) + 2g \right) + \left( 1 + 2n \right) l \right) } 
	\end{equation}
	\item
\end{enumerate}
\end{solution}
